...
public class TC05_Top_Ribbon_Functionality_Check
{
    @Test
    void Top_Ribbon_Functionality_Check()
    {
        IocBuilder.execute(Duration.ofMinutes(10), EResultData.ADMIN, "842", tc ->
        {
            ...
            boolean isHomePageOpened = tc.browser.getPageTitle().contains("Welcome");
            tc.addStepInfo("User is redirected to landing page", true, isHomePageOpened,
                    new ComparerOptions().takeScreenShotPlatform());
        });
    }
}
