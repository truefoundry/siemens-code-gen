...
public class TC06_Dispatcher_Role_Schedule_Task_Notification_Actions_AddtoClipboard
{
    @Disabled
    @Test
    void TC_06()
    {
        IocBuilder.execute(Duration.ofMinutes(10), EResultData.TMF_DISPATCHER_ROLE, "104819", tc ->
        {
