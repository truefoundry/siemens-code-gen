...
public class TC07_Dispatcher_Education_Role_Schedule_Task_Notification_Actions_AddtoClipboard
{
    @Test
    void TC_07()
    {
        IocBuilder.execute(Duration.ofMinutes(10), EResultData.TMF_DISPATCHER_EDUCATION_ROLE, "115722", tc ->
        {
            ...
            tc.addStepInfo("Below options should be reflected for each notification 'notification', 'Edit', " +
                    ...
                    tc.notification.getAllActions().containsAll(List.of("Edit", "Site Assigned Engineers",
                            ...
                            "Comment", "Check Rules", "Get Candidates", "Schedule", "Unschedule", "Relaxed Get Candidates")),new ComparerOptions().takeScreenShotPlatform());
